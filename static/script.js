...
{
  console.log("inside getCatagories() function")
...
console.log("inside loadcatagories (json_catagories) function");
  ...
  if (sub_catagory != null)
    {
      ...
      for (let ii = 0; ii < sub_catagory.length; ii++)
      {
        ...
        console.log("- data to be filled--" + sub_catagory[ii].catagory_name);
      ...
      console.log( html_sub_catagory)
        ...
        sub_catagory_check.insertAdjacentHTML('beforeend', html_sub_catagory )
